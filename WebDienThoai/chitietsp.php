...
<div class="content">
    ...
    <div class="main" style="margin-top: 0px">
        ...
        <div class="product-img" style="float: left;">
            <img width="450px" height="450px" src="images/sp.webp" alt="" style="position:absolute;">
            <img width="350px" style="margin: 80px 50px;" src="admin/modules/quanlysanpham/uploads/<?php echo $row_chitiet['product_image']?>" alt="">
        ...
        <div class="content-list-sp" style="overflow: hidden; width: 100%; margin-left: -10px">
            ...
            <li>
                <a href="chitietsp.php?product_id=<?php echo $row['product_id'] ?>">
                    ...
                    <img width="150px" style="margin: 40px 50px;" src="admin/modules/quanlysanpham/uploads/<?php echo $row['product_image'] ?>" alt="">
                </a>
