...
<div class="content9">
    ...
    <div class="main" style="margin-top: 40px;">
        <div class="sidebar">
            <div class="danhmuc">
                <p class="ten-tieude">TIN TỨC LIEN QUAN</p>
                <ul style="margin: -20px 0 0 -40px;">
                    ...
                    <li class="dm-sp">
                        <a href="chitiettintuc.php?id=<?php echo $result1['news_id'] ?>">
                            <img src="admin/modules/tintuc/uploads/<?php echo $result1['news_image'] ?>" alt="">
        ...
        <div style="margin-left: 15px; margin-top: -20px">
            ...
            <li>
                ...
                <p><img style="width: 500px; margin-left: 250px" src="admin/modules/tintuc/uploads/<?php echo $result2['news_image'] ?>" alt=""></p>
