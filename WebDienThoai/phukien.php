        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="10000">
                <img src="images/slidepk1.webp" style="height: 250px;" class="d-block w-100" alt="...">
                
              </div>
              <div class="carousel-item" data-bs-interval="2000">
                <img src="images/slidepk2.webp" style="height: 250px;" class="d-block w-100" alt="...">
                
              </div>
              <div class="carousel-item">
                <img src="images/slidepk3.webp" style="height: 250px;" class="d-block w-100" alt="...">
                    ...
                    <a href="chitietpk.php?pk_id=<?php echo $row_pro['pk_id'] ?>">
                        <div class="card" style="width: 19rem; height: 30rem; border: none;">
                            <div>
                                ...
                                <img src="admin/modules/phukien/uploads/<?php echo $row_pro['pk_anh'] ?>"  alt="..." style="margin-left: 60px; height: 180px; margin-top: 40px;" >
                            </div>
            ...
            <div style="height: 300px; width: 100%; margin-top: 50px; display: flex;">
                <div style="width:25%; height:300px;">
                    <div style="text-align: center; height: 200px; margin-top: 20px">
                        <div style="line-height: 150px;"><img src="images/icpk1.png" alt="" style="height: 90px;"></div>
                        <div>
                ...
                <div style="width:25%; height:300px;">
                    <div style="text-align: center; height: 200px; margin-top: 20px">
                        <div style="line-height: 150px;"><img src="images/icpk2.png" alt="" style="height: 90px;"></div>
                        <div>
                            <b>Đổi trả dễ dàng</b>
                ...
                <div style="width:25%; height:300px;">
                    <div style="text-align: center; height: 200px; margin-top: 20px">
                        <div style="line-height: 150px;"><img src="images/icpk3.png" alt="" style="height: 90px;"></div>
                        <div>
                ...
                <div style="width:25%; height:300px;">
                    <div style="text-align: center; height: 200px; margin-top: 20px">
                        <div style="line-height: 150px;"><img src="images/icpk4.png" alt="" style="height: 90px;"></div>
                        <div>
