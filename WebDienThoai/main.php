...
<div id="main" style="background-color: rgb(208, 4, 53);">
            <div class="img">
                <img src="images/bgr.webp">
            </div>
                
            <div class="img img1">
                <a href="#">
                    <img src="images/sticky3.png">
                </a>
            </div>

            <div class="img img2">
                <a href="#">
                    <img src="images/sticky4.png">
                </a>
            </div>

            <div class="content1">
                <img src="images/anh1.webp" > 
            </div>
    <!-- slider quảng cáo -->
            <div class="content4">
                <div class="gallery-display-area">
                    <div class="gallery-wrap">
                        <a href="#">
                                <img src="images/advt1.webp" alt="img1" class="imgslider1">
                        </a>
                        <a href="#">
                                <img src="images/advt2.webp" alt="img2" class="imgslider2">
                        </a>
                        <a href="#">
                                <img src="images/advt3.webp" alt="img3" class="imgslider3">
                        </a>
                        <a href="#">
                                <img src="images/advt4.webp" alt="img4" class="imgslider4">
                        </a>
                    ...
                    <?php
                        ...
                        <li> 
                            <a href="chitietsp.php?product_id=<?php echo $row_pro['product_id'] ?>">
                                <img src="images/sp.webp" alt="" style="position: absolute;">
                                <img src="admin/modules/quanlysanpham/uploads/<?php echo $row_pro['product_image'] ?>" alt="" style="height: 150px; margin: 33px 65px">
                                ...
                                <div class="prd_config">
                                    <img src="images/km.webp" alt="" style="border-radius: 50%; box-shadow: 0 0 0 1px #ffffff; width: 30px; margin-left: 20px">
    ...
    <!-- Ưu đãi -->
            <div class="content6">
                ...
                <div class="uudai">
                    ...
                    <a href="#">
                        <img src="images/pay2.webp" alt="">
                    </a>
                    <a href="#">
                        <img src="images/pay3.webp" alt="">
                    </a>
    ...
    <!-- Dịch vụ tiện ích -->
            <div class="content7" style="background-image: url(images/bgr2.webp);">
                ...
                <ul class="ic">
                    <a href="#">
                        <div class="item-img">
                            <img src="images/ic-water.png" alt="">
                        </div>
                        <div>
                    ...
                    <a href="#">
                        <div class="item-img">
                            <img src="images/service-item2.png" alt="">
                        </div>
                        <div>
                            <h3>
                    ...
                    <a href="#">
                        <div class="item-img">
                            <img src="images/service-item3.png" alt="">
                        </div>
                        <div>
                            <h3>
                    ...
                    <a href="#">
                        <div class="item-img">
                            <img src="images/ic-credit-card.png" alt="">
                        </div>
                        <div>
                            <h3>
                                <b>Thẻ game</b>
