...
<div class="content9">
    ...
    <form action="thanhtoanmomo.php" method="POST" target="_blank" enctype="application/x-ww-form-urlencoded" id="momo" style="display: none;">
        <input type="submit" name="payUrl" value="Thanh toán MoMo QRcode" class="btn btn-danger">
    </form>
    <br>
    <form action="thanhtoanmomo_atm.php" method="POST" target="_blank" enctype="application/x-ww-form-urlencoded" id="momo1" style="display: none;">
